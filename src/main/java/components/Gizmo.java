...
public class Gizmo extends Component {
    ...
    //    private Vector2f xAxisOffet = new Vector2f(56 / 80f, -4 / 80f);
//    private Vector2f yAxisOffet = new Vector2f(11 / 80f, 57 / 80f);

    private Vector2f xAxisOffet = new Vector2f(24 / 80f, -6 / 80f);
    private Vector2f yAxisOffet = new Vector2f(-7 / 80f, 21 / 80f);
    ...
    public void editorUpdate(float dt) {
        ...
        if (this.activeGameObject != null) {
            ...
            this.xAxisObject.transform.position.add(this.xAxisOffet);
            this.yAxisObject.transform.position.add(this.yAxisOffet);
        }
    }
